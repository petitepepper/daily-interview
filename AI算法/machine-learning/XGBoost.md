...
- $XGBoost$对$GBDT$进行了一系列优化：损失函数进行了二阶泰勒展开、目标函数加入**正则项**、**支持并行**、**默认缺失值**
...
- <font color='orange'>$LR$是线性模型</font>，可解释性强，很容易并行化，但学习能力有限，<font color='green'>需要</font>大量的人工<font color='green'>特征工程</font>
...
1. XgBoost理论理解，两个合起来看！

    **[xgboost入门与实战(原理篇) - 有英文的细推导](https://blog.csdn.net/sb19931201/article/details/52557382)** + [深入理解XGBoost (主要步骤)](https://zhuanlan.zhihu.com/p/83901304)

2. [Xgboost参数调优的完整指南及实战](https://blog.csdn.net/u010665216/article/details/78532619)

3. [推荐系统面试题之机器学习（一）树模型](https://blog.csdn.net/jamexfx/article/details/93780308)

4. [珍藏版 | 20道XGBoost面试题](https://mp.weixin.qq.com/s/a4v9n_hUgxNyKSQ3RgDMLA)

5. [梯度提升树(GBDT)原理小结 ](https://www.cnblogs.com/pinard/p/6140514.html)

5. [gbdt的残差为什么用负梯度代替？](https://www.zhihu.com/question/63560633/answer/569536833)